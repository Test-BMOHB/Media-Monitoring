...
##   2.2      04/19/2016    Justin Suelflow    Changed sleep time between pages to 5 seconds and took out duplicate error message logging
##-----------------------------------------------------------------------------
##*********************END HEADER*********************##
...
##  Loop through 10 pages of Google News
    ...
    ##  Sleep for 5 seconds in between Google News pages
                    time.sleep(5)
...
##  Sleep for 30 seconds in between search queries
            time.sleep(30)
        if mainRequest.status_code == requests.codes.ok:
            htmlLi = scrapeInfo(liLinks, paraXPath)
