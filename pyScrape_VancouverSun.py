...
##Log file saved at: /var/www/html/Logs/pylog_VancouverSun.txt
##CSV file saved at: /var/www/html/mmddyyyy_VancouverSun_Scrape.csv
##Run command: sudo python pyScrape_VancouverSun.py
##Static variables: '/var/www/html/Logs/pylog_VancouverSun.txt'
...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_VancouverSun.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_VancouverSun_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&q=site:www.vancouversun.com+'
    mainXPath = '//*[@class="g"]'
    paraXPath = '//p'
