...
##Date          : 4/11/2016
##Program Name  : pyScrape_NationalPost
##Description   : Loop through last 2 days worth of articles for National Post across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /var/www/html/Logs/pylog_NationalPost.txt
##CSV file saved at: /var/www/html/mmddyyyy_NationalPost_Scrape.csv
##Run command: sudo python pyScrape_NationalPost.py
##Static variables: '/var/www/html/Logs/pylog_NationalPost.txt'
...
##                                                  Changed to only look for National Post website
...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_NationalPost.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_NationalPost_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.nationalpost.com+'
