...
##Date          : 4/11/2016
##Program Name  : pyScrape_TorontoSun
##Description   : Loop through last 2 days worth of articles for Toronto Sun across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /Logs/pylog_TorontoSun.txt
##CSV file saved at: /Scrapes/mmddyyyy_TorontoSun_Scrape.csv
##Run command: sudo python pyScrape_TorontoSun.py
##Static variables: '/Logs/pylog_TorontoSun.txt'
...
##                                                  Changed to only look for Toronto Sun website
...
##  Open a log file and append to the end of the log
    logFile = open('/Logs/pylog_TorontoSun.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/Scrapes/' + fileDate + '_TorontoSun_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&q=site:www.torontosun.com+'
