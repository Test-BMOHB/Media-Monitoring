...
##Date          : 4/11/2016
##Program Name  : pyScrape_CTVNews
##Description   : Loop through last 2 days worth of articles for CTV News across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /var/www/html/Logs/pylog_CTVNews.txt
##CSV file saved at: /var/www/html/mmddyyyy_CTVNews_Scrape.csv
##Run command: sudo python pyScrape_CTVNews.py
##Static variables: '/var/www/html/Logs/pylog_CTVNews.txt'
...
##                                                  Changed to only look for CTV News website
...
##  Open a log file and append to the end of the log
    logFile = open('/Logs/pylog_CTVNews.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/Scrapes/' + fileDate + '_CTVNews_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.ctvnews.ca/canada+'
