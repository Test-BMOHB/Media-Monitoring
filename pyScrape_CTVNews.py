...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_CTVNews.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_CTVNews_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&q=site:www.ctvnews.ca/canada+'
    mainXPath = '//*[@class="g"]'
    paraXPath = '//p'
