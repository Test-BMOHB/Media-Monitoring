...
##Date          : 4/07/2016
##Program Name  : pyScrape_MontrealGazette
##Description   : Loop through last 2 days worth of articles for Montreal Gazette across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /var/www/html/Logs/pylog_MontrealGazette.txt
##CSV file saved at: /var/www/html/mmddyyyy_MontrealGazette_Scrape.csv
##Run command: sudo python pyScrape_MontrealGazette.py
##Static variables: '/var/www/html/Logs/pylog_MontrealGazette.txt'
...
##                                                  Changed to only look for Montreal Gazette website
...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_MontrealGazette.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_MontrealGazette_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.montrealgazette.com+'
