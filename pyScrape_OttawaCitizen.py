...
##Description   : Loop through last 2 days worth of articles for Ottawa Citizen across a possible 10 pages of Google News to pull nouns from the articles
...
##                                                  Changed to only look for Ottawa Citizen website
...
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.ottawacitizen.com+'
