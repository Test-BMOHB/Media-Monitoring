...
##Date          : 4/11/2016
##Program Name  : pyScrape_GlobeMail
##Description   : Loop through last 2 days worth of articles for Globe & Mail across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /var/www/html/Logs/pylog_GlobeMail.txt
##CSV file saved at: /var/www/html/mmddyyyy_GlobeMail_Scrape.csv
##Run command: sudo python pyScrape_GlobeMail.py
##Static variables: '/var/www/html/Logs/pylog_GlobeMail.txt'
...
##   1.2      04/11/2016    Justin Suelflow    Changed log file path
##   1.3      04/12/2016    Justin Suelflow    Changed from 7 days to current day minus 1 day because runtime is long
##                                                  Changed to only look for Globe & Mail website
##   1.4      04/12/2016    Justin Suelflow    Added code to break from page incrementing
...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_GlobeMail.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_GlobeMail_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.theglobeandmail.com+'
