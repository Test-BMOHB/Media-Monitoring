...
##Date          : 4/11/2016
##Program Name  : pyScrape_TorontoStar
##Description   : Loop through last 2 days worth of articles for Toronto Star across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /Logs/pylog_TorontoStar.txt
##CSV file saved at: /Scrapes/mmddyyyy_TorontoStar_Scrape.csv
##Run command: sudo python pyScrape_TorontoStar.py
##Static variables: '/Logs/pylog_TorontoStar.txt'
...
##                                                  Changed to only look for Toronto Star website
...
##  Open a log file and append to the end of the log
    logFile = open('/Logs/pylog_TorontoStar.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/Scrapes/' + fileDate + '_TorontoStar_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&q=site:www.thestar.com+'
