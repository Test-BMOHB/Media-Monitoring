...
##Log file saved at: /var/www/html/Logs/pylog_TorontoStar.txt
##CSV file saved at: /var/www/html/mmddyyyy_TorontoStar_Scrape.csv
##Run command: sudo python pyScrape_TorontoStar.py
##Static variables: '/var/www/html/Logs/pylog_TorontoStar.txt'
...
##  Open a log file and append to the end of the log
    logFile = open('/var/www/html/Logs/pylog_TorontoStar.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/var/www/html/' + fileDate + '_TorontoStar_Scrape.csv'
