...
##Date          : 4/11/2016
##Program Name  : pyScrape_CalgaryHerald
##Description   : Loop through last 2 days worth of articles for Calgary Herald across a possible 10 pages of Google News to pull nouns from the articles
...
##Log file saved at: /Logs/pylog_CalgaryHerald.txt
##CSV file saved at: /Scrapes/mmddyyyy_CalgaryHerald_Scrape.csv
##Run command: sudo python pyScrape_CalgaryHerald.py
##Static variables: '/Scrapes/pylog_CalgaryHerald.txt'
...
##                                                  Changed to only look for Calgary Herald website
...
##  Open a log file and append to the end of the log
    logFile = open('/Logs/pylog_CalgaryHerald.txt','a')
    logFile.write(text)
##  Close log file
    logFile.close()
...
##  Try to download NLTK packages
    ...
    writeToLog('*****************************' + fileDate + '*****************************\n')
    fileName = '/Scrapes/' + fileDate + '_CalgaryHerald_Scrape.csv'
##  Declare list of search queries
    ...
    mainURL = 'https://www.google.com/search?source=lnms&tbm=nws&tbs=qdr:w,sbd:1&num=100&q=site:www.calgaryherald.com+'
